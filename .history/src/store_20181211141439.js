const store = {
  ...
  services: [
    ...
    },
    {
      ...
      breakdown: ['Custom Fyke nets', 'lobster rope doormats'],
    },
    {
      name: 'property management',
      image: 'property-management.jpg',
      description:
        'Pariatur aliquip do aliquip reprehenderit consequat proident elit in. Laboris commodo elit consectetur culpa esse enim ea non fugiat id eu aute ipsum commodo. Proident laboris incididunt veniam adipisicing duis ex.',
    },
    {
      name: 'glass',
      image: 'glass.jpg',
      description:
        'Nulla ullamco eiusmod cupidatat dolor ex ea. Consequat pariatur laborum velit nulla ad et sunt nulla aliquip. In officia qui culpa enim reprehenderit et ipsum excepteur minim sint sint. Tempor exercitation do dolore aliqua qui anim laborum magna.',
      breakdown: [
    ...
    },
    {
      ...
      description:
        'Ex minim adipisicing laborum culpa est. Lorem irure qui velit officia laboris. Esse eiusmod tempor amet anim proident.',
      breakdown: 'Custom signs made to order in any shape or size.',
    },
  ],
